...
checkStickyNav = function(){
  fixedNavOffset = $('#site-nav').offset().top;
  if( $(window).scrollTop() >= fixedNavOffset && isCanvasNavLoaded){
...
function contactPush(){window.location ='http://www.forthepeople.com/free-case-evaluation';}
