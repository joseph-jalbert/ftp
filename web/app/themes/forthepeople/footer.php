...
<?php } else { ?>
<div class="serving-headline">Serving All of Florida, Georgia, Mississippi, Tennessee, Kentucky, New York &amp; Pennsylvania</div>
<?php } ?>
<footer id="footer">
        ...
        <div class="span4 hidden-phone">
          ...
          <div class="row-fluid">
			<div class="consumer-alerts-form" id="consumer-alerts-form">
				...
				<?php
				if ( is_active_sidebar( 'footer_contact_widget' ) ) {

					dynamic_sidebar( 'footer_contact_widget' );
