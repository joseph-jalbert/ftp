...
<div id="breadcrumbs" class="force-fullwidth">
	<div class="row-fluid">
		<div id="col0" class="span12">
			...
			<?php if (!is_search() && ((is_child('6110') && !is_page_template('attorney-referrals.php')) || 'business-litigation' == $menuslug || false !== strpos( $post->post_name, 'business-litigation-attorneys' ))) { ?>
